...
gulp.task('integrationMulti', function () {
    try {
        ...
        // var reviewsData = "", customerSupportData = "", formsData = "";
        var integrations = [];
    ...
    //     const body3 = request('https://api.zapier.com/v1/apps?client_id='+ clientId+ '&category=forms', function (error, response, body) {
    //         if (!error && response.statusCode == 200) {
    //             responseData3 = JSON.parse(body);
    //             // Process each object in the first API response
    //             responseData3.objects.forEach((app) => {
    //                 sleep.sleep(2);
    //                 const fileName = `spam-protection-for-${app.slug}.html`;
    //                 const filePath = path.join('./integrations', fileName);
    ...
    //     });
        ...
        const body = request('https://api.zapier.com/v1/apps?client_id='+ clientId+ '&category=reviews', function (error, response, body) {
            if (!error && response.statusCode == 200) {
                responseData1 = JSON.parse(body);
        
                // Process each object in the first API response
                responseData1.objects.forEach((app) => {
                    const fileName = `spam-protection-for-${app.slug}.html`;
                    const filePath = path.join('./integrations', fileName);
        ...
        // Make the second GET request (replace with your actual second endpoint)
        // const body2 = request('https://api.zapier.com/v1/apps?client_id='+ clientId+ '&category=customer-support', function (error2, response2, body2) {
        //     if (!error2 && response2.statusCode == 200) {
        //         responseData2 = JSON.parse(body2);
    
        //         // Process each object in the second API response
        //         responseData2.objects.forEach((app) => {
        //             const fileName = `spam-protection-for-${app.slug}.html`;
        //             const filePath = path.join('./integrations', fileName);
        ...
        //         // if (responseData1 != null &&  responseData2 != null && responseData3 != null)
                
        //         // Process files in the 'pages/integrations/' directory
...
//     request('https://api.zapier.com/v1/apps?client_id=7FxT2JmtifErQYpz0cus12zRucRJtW8jsfJhfYpl&category=forms', function (error, response, body) {
//         if (!error && response.statusCode == 200) {
//             // Parse the JSON response
//             const responseData = JSON.parse(body);

//             // Process each object in the API response
//             responseData.objects.forEach((app) => {
//                 const fileName = `spam-protection-for-${app.slug}.html`; // Create a unique file name based on the title or slug
//                 const filePath = path.join('./integrations', fileName);
...
//             // Pass specific data to Nunjucks (optional)
//             return gulp.src('pages/integrations/*.+(html|nunjucks)')
//                 .pipe(data(function () {
//                     return {
//                         appsData: responseData.objects // Pass the 'objects' array from the API response
//                     };
//                 }))
//                 .pipe(nunjucksRender({
//                     path: ['templates']
